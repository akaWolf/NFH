...
The PC-experience profile (docs/PC_FIDELITY.md §7; the default since 2026-09-09 — the numbers in this file are the mobile-parity runtime's, `NFH_PROFILE=mobile` / `--profile=mobile`) is a
