...
| the S1 trick step's order (the action, the fire, the shout, the repair) and the shout's choice | `play_angry` (AngryHard 6.8 s after every trick, the mobile fix clips, the tricked clip paced to the normal stay) | fcn.0047bd00 as slot 2 of vtable 0x4e5944 (the OBJ2 step fcn.0047c290, the five-argument fcn.0047c320), the shout tables 0x51b584-0x51b5a4, fcn.0047ae70's repair, objects.xml's tricked actions | read 2026-09-22 (docs/PC_ROUTINES.md "The fire's tail"): the order agrees except at the five-argument sites (the fire before the slip, hair and towel clips); the shout (7.67 s on a bonus, 2.1-3.75 cold, none on flag 2), the repair and the tricked action lengths differ — documented with the numbers in docs/PC_FIDELITY.md "Season 1 reactions", not carried |
