...
- Woody's Season 1 walk: the port walks him on the mobile scene's paths
  ...
  model's station split against E13's bubbles is in docs/PC_LAPS.md. Two
  legs of the model stand off the videos: E08's coffee station (29.8 s
  from the balcony's ewer, the video's ~26) and E14's kitchen-workshop
  walks (the cups' and the polish's spans 19-20 and 18-19 s against 24.3
  and 23.6) — docs/PC_FIDELITY.md "The walker's arguments".
