...
time the Loader's: the oneshot's frames less one; the step lasts the time + 2) —
`shout2_extra` (92 frames, 91 ticks, a 93-tick step, 7.75 s) when the trick was a bonus, else by
the points: ≤ 5 shout0_light (25 frames, 24 ticks, 26 as the step, 2.17 s) or shout2 (26, 25,
27, 2.25 s), ≤ 10 shout0_medium (45, 44, 46, 3.83 s) or shout2, > 10 shout0 (26, 25, 27,
2.25 s) or shout2 — the second
...
and every bonus trick is followed by the 7.75 s shout2_extra (the Loader's 91 ticks, a 93-tick step).
