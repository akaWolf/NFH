...
time the Loader's: the oneshot's frames less one; its timer job lasts the time + 1) —
`shout2_extra` (92 frames, 91 ticks, a 92-tick job, 7.67 s) when the trick was a bonus, else by
the points: ≤ 5 shout0_light (25 frames, 24 ticks, 25 with the job, 2.08 s) or shout2 (26, 25,
26, 2.17 s), ≤ 10 shout0_medium (45, 44, 45, 3.75 s) or shout2, > 10 shout0 (26, 25, 26,
2.17 s) or shout2 — the second
...
and every bonus trick is followed by the 7.67 s shout2_extra (the Loader's 91 ticks, a 92-tick job).
