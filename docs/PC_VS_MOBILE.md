...
| Season 2 100 % | points, the COLLAPSE! board of all thirteen end screens: 1000 a coin + 3000 for a collapse (once — E10 and E14 fill the gauge twice and still get 3000) + 5000 for the trophy, i.e. every coin (the HUD statue lights at 8/8, not at the overflow: E10 grey after the 299 s fill, gold after the eighth coin at 342) + ⌊500000 / seconds played⌋ (498-500 k on all thirteen: 160 s → 3123, 464 s → 1077; E10: 8000 + 3000 + 5000 + 1398 = 17398), the map counting coins 8/8; the gauge decays ~0.4 %/s (measured: E07 17→0 in 46 s, E04 62→51 in 26 s) and may fill ANY number of times — Badinfos' 100 % run fills it twice in 210 (299, 342 s) and 214 (396, 447 s) | int(completed × 90 / total) + 10 iff AngryCountTicks == 1 (cs:413-416): the meter must overflow EXACTLY once; 0.37/s decay (the PC's constant), no pause (Rottweiler.cs:793-796) |
